...
namespace Easings.Interpolator {
    public class Interpolator : MonoBehaviour {
        ...
        /// <summary>
        /// Start an easing animation starting with [startValue] and ending at [endValue] over [duration] (with optionally [unscaledTime]) interpolated using the [easing] function, calling [onUpdate] every frame, and optionall [onDone] when complete.
        /// </summary>
        ...
        /// <summary>
        /// Start an easing animation starting with 0 and ending at 1 over [duration] (with optionally [unscaledTime]) interpolated using the [easing] function, calling [onUpdate] every frame, and optionall [onDone] when complete.
        /// </summary>
        /// <param name="duration">The ease [duration].</param>
        /// <param name="easing">The predefined [easing] type to use.</param>
        /// <param name="onUpdate">The function to call every frame, passing in the current EaseData.</param>
